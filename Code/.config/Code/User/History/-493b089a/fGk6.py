...
class Base:
    ...
    def todayChal(self):
        challenges:list = []
        for i in range(0, int(pyautogui.prompt(text="Enter No of Challenges: ",title="Post"))):
            challenges.append(str(pyautogui.prompt(text=f"Enter Challenge {i+1}: ",title="Challenges")))
        return challenges
