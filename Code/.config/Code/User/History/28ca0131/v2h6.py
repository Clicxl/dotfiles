...
class Camera(pygame.sprite.Group):
    ...
    def update(self,dt,target):
        ...
        self.offset.x += (target.rect.centerx - WIDTH/2 - (WIDTH/2 - mouse[0])/4 - self.offset.x) * (self.dt * self.delay)
        self.offset.y += (target.rect.centery - HEIGHT/2 - (HEIGHT/2 - mouse[1])/4 - self.offset.y) * (self.dt * self.delay)
