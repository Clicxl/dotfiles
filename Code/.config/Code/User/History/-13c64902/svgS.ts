const element_usernameInput: HTMLInputElement = document.getElementById(
  "username"
) as HTMLInputElement;
const element_emailInput: HTMLInputElement = document.getElementById(
  "email"
) as HTMLInputElement;
const element_passwordInput: HTMLInputElement = document.getElementById(
  "password"
) as HTMLInputElement;
const element_submitButton: HTMLInputElement =
  document.getElementById("submit");

let usernameHasError = false;
element_usernameInput.addEventListener("input", (event) => {
...
element_usernameInput.addEventListener("focusout", (event) => {
...
element_emailInput.addEventListener("input", (event) => {
...
element_emailInput.addEventListener("focusout", (event) => {
...
element_passwordInput.addEventListener("input", (event) => {
...
function createErrorElement(id, insertAfter) {
  ...
  document
    .getElementById(insertAfter)
    .insertAdjacentElement("afterend", errElement);
}
