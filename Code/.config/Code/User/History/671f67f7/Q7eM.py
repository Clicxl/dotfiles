...
def twitterCreate():
    ...
    if shotMatch("assets/Twitter/upload.png"):
        ...
        sleep(2)
        # Explorer
        if shotMatch("assets/Twitter/video.png"):
            pag.click(shotMatch("assets/Twitter/video.png")[1])
            sleep(1)
            if shotMatch("assets/Twitter/modified1.png"):
                pag.doubleClick(618, 119)
            elif shotMatch("assets/Twitter/modified2.png"):
                pag.click(shotMatch("assets/Twitter/modified2.png")[1])
                pag.doubleClick(618, 119)
