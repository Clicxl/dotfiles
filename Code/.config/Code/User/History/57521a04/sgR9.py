...
# Utils
    ...
    def custom_crosshair(self):
        ...
        crosshari = pygame.image.load(
            "assets/Images/game_assets/Crosshair.png").convert_alpha()
        crosshair_rect = crosshari.get_rect(center=pygame.mouse.get_pos())
        self.screen.blits(crosshari, crosshair_rect)
