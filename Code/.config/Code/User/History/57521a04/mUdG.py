...
# Utils
    ...
    def custom_crosshair(self):
        ...
        crosshari = pygame.transform.scale(pygame.image.load(
            "assets/Images/game_assets/Crosshair.png").convert_alpha(), (TILESIZE*SCALE, TILESIZE*SCALE))
        crosshair_rect = crosshari.get_frect(center=pygame.mouse.get_pos())
        self.screen.fblit(crosshari, crosshair_rect.center)
