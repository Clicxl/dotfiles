...
cheeta = Runner(40.0,CIRCUMFERENCE)
        
print(f"Snail Time: {round(snail.years)}")
print(f"Cheeta Time: {round(cheeta.years,3)}")

if round(snail.years) <= round(cheeta.years):
    print(f"Snail is First to reach the dead line by {round(cheeta.years - snail.years)} years")
else:
    print(f"Cheeta is First to reach the dead line by {round(snail.years - cheeta.years)} years")
