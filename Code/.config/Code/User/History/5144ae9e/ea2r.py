...
if round(snail.years) <= round(cheeta.years):
    print(f"Cheeta is First to reach the dead line by {round(cheeta.years - snail.years)}" years)
else:
    print(f"Snail is First to reach the dead line by {round(snail.years - cheeta.years)} years")
