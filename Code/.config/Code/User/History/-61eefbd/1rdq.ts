...
// Challenge 13 - Generics <T>
function genericArray<T>(amt:number,value:T): T[]{
  return Array(amt).fill(value)
}

const someString: string[] = genericArray<string>(5, "Hello")
console.log(someString);
console.log(genericArray<number>(10,123));
