...
import {element_loginLink,element_loginText , element_createaccountLink , element_createaccountText, element_verifyErrorElement, element_verifyConfirmElement, element_sendEmail} from "./CONSTANTS"
...
element_sendEmail.addEventListener("click", (event) => {
  resendConfirmEmail();
});
