...
class GUI:
    ...
    def main_word_frame(self,width,height,font:str):
        ...
        self.letStr1.trace_add(
            'write', lambda var, index, mode: self.logic.one_word(var=var, index=index, mode=mode,strvar=self.letStr1,focus=self.letter2))
...
class GameLogic:
    ...
    def one_word(self, var, index, mode,strvar,focus):
        self.strvar = strvar
        self.focus = focus
