    ...
    def main_word_frame(self, width, height, font: str):
        ...
        self.letStr1.trace_add(
            ...
            lambda var, index, mode: self.logic.one_word(
                var=var, index=index, mode=mode, strvar=self.letStr1, focus=self.letter2 , unfocus=self.letter1
            ),
        )
        ...
        self.letStr2.trace_add(
            "write",
            lambda var, index, mode: self.logic.one_word(
                var=var, index=index, mode=mode, strvar=self.letStr2, focus=self.letter3
            ),
        )
