...
class GUI:
    ...
    def main_word_frame(self, width, height, font: str):
        ...
        self.letStr3.trace_add(
            "write",
            lambda var, index, mode: self.logic.one_word(
                var=var, index=index, mode=mode, strvar=self.letStr3, focus=self.letter4, unfocus=self.letter3
            ),
        )
        ...
        self.letStr4.trace_add(
            "write",
            lambda var, index, mode: self.logic.one_word(
                var=var, index=index, mode=mode, strvar=self.letStr4, focus=self.letter5, unfocus=self.letter4
            ),
        )
        ...
        self.letStr5.trace_add(
            "write",
            lambda var, index, mode: self.logic.one_word(
                var=var, index=index, mode=mode, strvar=self.letStr5, focus=None, unfocus=self.letter5
            ),
        )
