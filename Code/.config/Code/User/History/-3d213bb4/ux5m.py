...
class GUI:
    ...
    def good_words_frame(self):
        ...
        self.letters.trace_add('write',callback=lambda var, index, mode: self.logic.autocomma(
                var=var,
                index=index,
                mode=mode,
                Stringvar=self.letters),Entry=self.letters)
