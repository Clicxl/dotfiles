...
class GUI:
    ...
    def main_word_frame(self, width, height, font: str):
        ...
        self.letStr1.trace_add(
            ...
            lambda var, index, mode: self.logic.one_word(
                var=var, index=index, mode=mode, strvar=self.letStr1, focus=self.letter2 , unfocus=None
            ),
        )
        ...
        self.letStr2.trace_add(
            "write",
            lambda var, index, mode: self.logic.one_word(
                var=var, index=index, mode=mode, strvar=self.letStr2, focus=self.letter3,unfocus=self.letter1
            ),
        )
        ...
        self.letStr3.trace_add(
            "write",
            lambda var, index, mode: self.logic.one_word(
                var=var, index=index, mode=mode, strvar=self.letStr3, focus=self.letter4, unfocus=self.letter2
            ),
        )
        ...
        self.letStr4.trace_add(
            "write",
            lambda var, index, mode: self.logic.one_word(
                var=var, index=index, mode=mode, strvar=self.letStr4, focus=self.letter5, unfocus=self.letter3
            ),
        )
        ...
        self.letStr5.trace_add(
            "write",
            lambda var, index, mode: self.logic.one_word(
                var=var, index=index, mode=mode, strvar=self.letStr5, focus=None, unfocus=self.letter4
            ),
        )
    ...
    def good_words_frame(self):
        ...
        self.letters = ttk.StringVar()
        self.letters = ttk.Entry(
            master=self.good, font="Segoe_UI", textvariable=self.letters
        )
        self.logic.word_sep(self.letters)

        self.good_word.pack(side="left", padx=10)
        self.letters.pack(side="left", padx=10)
